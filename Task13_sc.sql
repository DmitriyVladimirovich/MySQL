...
-- 1
-- select title, descr from chats, users where username='user 1' order by title desc;
-- 2
-- select title, enter_datetime from chats, users_to_chats, users where users.username='user 2' and users.id=users_to_chats.user_id and chats.id=users_to_chats.chat_id order by enter_datetime;
-- 3
select title, enter_datetime from chats, users_to_chats where chats.title='chat 1' and chats.owner_id=users_to_chats.user_id and users_to_chats.chat_id=chats.id;
